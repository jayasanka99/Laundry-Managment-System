...
if (isset($_POST['update'])) {
    ...
    if ($password === $con_password) {
        ...
        $query = "INSERT INTO update(first_name, last_name, address, contact_number, email, student_id, password) VALUES('{$first_name}', '{$last_name}', '{$address}', '{$contact_number}', '{$email}', '{$student_id}', '{$password}')";
